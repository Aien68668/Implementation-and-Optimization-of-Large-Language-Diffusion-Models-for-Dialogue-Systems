...
src_path = "/root/LLaDA-main/gsm8k/gsm8k.jsonl"
trg_path = "/root/LLaDA-main/out/LLDA_gsm8k_test_nothink.res"
...
for i in trange(len(prompts)):
    ...
    item = {
        ...
        "ground_truth": obj.get("final_answer", ""),
